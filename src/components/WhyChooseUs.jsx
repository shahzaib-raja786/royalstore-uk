...
const points = [
  ...
  },
  {
    ...
    icon: <FaGem className="w-8 h-8 md:w-10 md:h-10" />,
  ...
  },
  {
    ...
    icon: <FaTags className="w-8 h-8 md:w-10 md:h-10" />,
    gradient: "from-[#ff6b00] to-[#ff2a00]",
...
export default function WhyChooseUs() {
  return (
    <section className="py-12 md:py-20 px-4 sm:px-6 text-center relative overflow-hidden">
      {/* Background decorative elements */}
      <div className="absolute inset-0 overflow-hidden -z-10">
        <div className="absolute top-10 left-10 w-64 h-64 bg-gradient-to-r from-orange-50 to-transparent rounded-full blur-3xl opacity-30"></div>
        <div className="absolute bottom-10 right-10 w-64 h-64 bg-gradient-to-l from-orange-50 to-transparent rounded-full blur-3xl opacity-30"></div>
      </div>
      ...
      >
        <div className="inline-flex items-center gap-2 mb-3">
          <div className="w-8 h-1 bg-gradient-to-r from-[#ff6b00] to-[#ff2a00] rounded-full"></div>
          <span className="text-sm font-semibold text-[#de5422] uppercase tracking-wider">
            Advantages
          </span>
          <div className="w-8 h-1 bg-gradient-to-l from-[#ff6b00] to-[#ff2a00] rounded-full"></div>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6 max-w-7xl mx-auto relative z-10 px-2">
      ...
      >
        <div className="inline-flex flex-col sm:flex-row items-center gap-3 md:gap-4 bg-gradient-to-r from-orange-50 to-amber-50 px-6 md:px-8 py-4 md:py-6 rounded-xl md:rounded-2xl border border-orange-100">
